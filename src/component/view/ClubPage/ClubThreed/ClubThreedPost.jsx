...
export default function ClubThreedPost({ postObj, isOwner }) {
    ...
    const onDeleteClick = async () => {
        ...
        if (ok) {
            await deleteDoc(doc(db, "clubthreed", postObj.id));
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await updateDoc(doc(db, `clubthreed/${postObj.id}`), { text: newPost });
        setEditing(false);
    }
