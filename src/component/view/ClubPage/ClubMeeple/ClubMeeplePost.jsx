...
export default function ClubMeeplePost({ postObj, isOwner }) {
    ...
    const onDeleteClick = async () => {
        ...
        if (ok) {
            await deleteDoc(doc(db, "clubmeeple", postObj.id));
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await updateDoc(doc(db, `clubmeeple/${postObj.id}`), { text: newPost });
        setEditing(false);
    }
