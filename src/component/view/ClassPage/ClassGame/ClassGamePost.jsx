...
export default function ClassGamePost({ postObj, isOwner }) {
    ...
    const onDeleteClick = async () => {
        ...
        if (ok) {
            await deleteDoc(doc(db, "classgame", postObj.id));
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await updateDoc(doc(db, `classgame/${postObj.id}`), { text: newPost });
        setEditing(false);
    }
